...
{
	private readonly Argument<ListArgument> argument = new("listArgument");
	private readonly Option<KeyType> typeOption = new("--type") { Description = "Cache structure type" };
	...
	{
		Aliases.Add("ls");
		argument.DefaultValueFactory = _ => ListArgument.Keys;
		Arguments.Add(argument);
		typeOption.DefaultValueFactory = _ => KeyType.Set;
	...
	{
		var listArgument = parameters.GetValue(argument);
		var type = parameters.GetValue(typeOption);
