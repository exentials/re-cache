...
namespace Exentials.ReCache.Server.Services
{
    ...
    public sealed class GrpcCacheService : RpcCacheService.RpcCacheServiceBase
    {
        private readonly ReCacheProvider _cache;

        public GrpcCacheService(ReCacheProvider cacheProvider)
        {
