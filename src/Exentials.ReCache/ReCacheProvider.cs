...
namespace Exentials.ReCache
{
	...
	public sealed class ReCacheProvider
	{
		...
		public void DeserializeFrom(Stream stream)
		{
			...
			var items = JsonSerializer.Deserialize<ConcurrentDictionary<ReCacheKey, ReCacheEntry>>(stream, jsonSerializerOptions);
		...
		public void SerializeTo(Stream stream)
		{
			...
			JsonSerializer.Serialize(stream, _concurrentDictionary, jsonSerializerOptions);
		}
